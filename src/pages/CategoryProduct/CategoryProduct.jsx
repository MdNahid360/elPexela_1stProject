...
import baner from "../../assets/img/banner/home-slider-03.png";
              ...
              {filteredProducts.map((itm) => (
                <div className="bg-white p-4 text-black rounded-lg shadow-md">
                  <Link className="hover-menu" to={`/products/${itm?._id}`}>
                    <div className="lg:h-[360px] md:h-[200px] border p-2 rela w-full relative overflow-hidden duration-200 hover-box">
                      {" "}
                      <img
